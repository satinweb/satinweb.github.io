...
$(function(){function e(){$(".carousel-services-item").each(function(){var e=$(this),i=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-image").css("min-height",i)})}function i(){$(".carousel-services-content").equalHeights()}function i(){$(".review").equalHeights()}$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],offCanvas:{position:"right"},navbar:{title:"<h2>Astin<span>WEB</span></h2>"}});var o=$("#my-menu").data("mmenu");o.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),o.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".popup-with-move-anim").magnificPopup({type:"inline",midClick:!0,fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,removalDelay:300,mainClass:"my-mfp-zoom-in"}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").animate({scrollTop:0},"slow","swing")}),$(".mouse-icon").click(function(){$("#my-content").animate({scrollTop:0},"slow","swing")}),$(".reviews").owlCarousel({items:1,loop:!0,smartSpeed:700,nav:!0,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],dots:!0,responsiveClass:!0,responsive:{0:{nav:!1},600:{nav:!1,items:1},1e3:{nav:!0,loop:!0}}}),$(".carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-services").owlCarousel({loop:!0,nav:!0,dots:!1,smartSpeed:700,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$("nav a").mPageScroll2id(0),e(),$(".carousel-services-composition h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$(".calc select").change(function(){$edition=$("select#card-edition").val(),$paper=$("select#card-paper").val(),$color=$("select#card-color").val(),$paper_ratio=$("select#card-paper option:selected").attr("data-paper-ratio"),$print_file=$("select#card-color option:selected").attr("data-print-file"),$color_format=$("select#card-color option:selected").attr("data-color"),$print=$("select#card-color option:selected").attr("data-print"),$division=30,$final_edition=$edition/$division,$price=$final_edition*$paper_ratio+parseInt($print_file)+$final_edition*$print,$("span#final-price").text($price),1==$color_format&&($(".card-images img").hide("slow"),$("#card-1-0").show("slow")),2==$color_format&&($(".card-images img").hide("slow"),$("#card-1-1").show("slow")),3==$color_format&&($(".card-images img").hide("slow"),$("#card-4-0").show("slow")),4==$color_format&&($(".card-images img").hide("slow"),$("#card-4-1").show("slow")),5==$color_format&&($(".card-images img").hide("slow"),$("#card-4-4").show("slow"))}),$(".userinput").focus(function(){$(this).parent().addClass("focus")}).blur(function(){""===$(this).val()&&$(this).parent().removeClass("focus")}),$(".message").focus(function(){$(this).parent().addClass("active")}).blur(function(){""===$(this).val()&&$(this).parent().removeClass("active")}),$(".carousel-services-content").equalHeights(),i(),window.onResize=function(){},i(),window.onResize=function(){}});
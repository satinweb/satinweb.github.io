...
$(function(){$("#header-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],offCanvas:{position:"right"},navbar:{title:"<h1>SATIN</h1>"}});var e=$("#my-menu").data("mmenu");e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")})});